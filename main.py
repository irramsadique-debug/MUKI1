...
# --------------------------------------------------------------------------
# 1. CONFIG (from environment variables set in .env or Render)
# --------------------------------------------------------------------------
RAW_DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://cryptoadmin:password@localhost:5432/crypto_platform")
# Fix for Render/Heroku postgres:// URLs to postgresql:// for SQLAlchemy compatibility
