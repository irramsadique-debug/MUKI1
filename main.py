...
Run: docker compose up -d --build   (root folder se)
"""
...
# --------------------------------------------------------------------------
# 1. CONFIG (from environment variables set in .env)
# --------------------------------------------------------------------------
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://cryptoadmin:password@db:5432/crypto_platform")
    ...
    try:
        ...
        for symbol in symbols:
            try:
                ...
                if sig:
                    # purana active signal usi symbol/direction ke liye hai to naya na banao
